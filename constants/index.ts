export const lessons = [
  {
    ...
    tasks: [
      [
        ...
        {
          id: "t2",
          title: "Pastki tokchani top.",
        },
        {
          id: "t3",
          title: "Yulbarsni top va uni olib qo'y.",
        },
        {
          id: "t4",
          title: "O'rta tokchani top.",
        },
        {
          id: "t5",
          title: "Yulbarsni o'rta tokchaga qo'y.",
        },
        {
          id: "t6",
          title: "Joylashganini tekshir.",
        },
      ],
    ],
    ...
    content: {
      html: '<img src="/img/lessons_img/lesson1_1.jpg" alt="Lesson 1" title="Lesson-1 img" width="100%" height="500" /> <img src="/img/lessons_img/lesson1_2.jpg" alt="Lesson 1" title="Lesson-1 img" width="100%" height="500" /> <img src="/img/lessons_img/lesson1_3.jpg" alt="Lesson 1" title="Lesson-1 img" width="100%" height="500" /> <img src="/img/lessons_img/lesson1_4.jpg" alt="Lesson 1" title="Lesson-1 img" width="100%" height="500" /> ',
    },
    slug: "lesson1",
  },
  {
    ...
    tasks: [
      [
        {
          id: "t1",
          title: "Pingvinchalar javonning 1-tokchasida joylashganini tuzatish",
        },
        {
          id: "t2",
          title: "Pingvinchalar javonning 2-tokchasida joylashganini tuzatish",
        },
      ],
      [
        {
          id: "t1",
          title: "Pingvinchalar javonning 3-tokchasida joylashganini tuzatish",
        },
        {
          id: "t2",
          title: "Pingvinchalar javonning 4-tokchasida joylashganini tuzatish",
        },
        {
          id: "t3",
          title: "Pingvinchalar javonning 5-tokchasida joylashganini tuzatish",
        },
      ],
    ],
    video: "https://www.youtube.com/embed/QiSEgUEEbF8",
