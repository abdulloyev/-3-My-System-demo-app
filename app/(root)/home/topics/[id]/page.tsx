...
function SlugPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="bg-gradient-to-t from-blue-300 via-pink-200 to-yellow-200">
      <div className="mx-auto px-3 pt-16 max-w-7xl">
        <h1 className="font-roboto text-4xl md:text-5xl lg:text-6xl text-blue-400">
          {blog.title}
        </h1>
        ...
        <div className="relative mt-12 flex max-md:flex-col-reverse md:gap-12">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger>
                <p className="flex justify-center items-center text-xl font-bold animate-pulse text-rose-500 uppercase">
                  <BookOpenText className="mr-2 h-7 w-7" /> qo`llanma
                </p>
              </AccordionTrigger>
              <AccordionContent>
                <div className="prose text-black/80 max-w-none flex-1">
